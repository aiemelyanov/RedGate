CREATE TABLE apex_030200.wwv_mig_frm_menu_menuitem (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_mnuitem_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_mnuitem_id_fk FOREIGN KEY (menu_id) REFERENCES apex_030200.wwv_mig_frm_menu ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_mnuitem_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);