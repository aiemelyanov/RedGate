CREATE TABLE apex_030200.wwv_mig_olb_olt_blk_item (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_olt_blk_item_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_olt_bi_blk_id_fk FOREIGN KEY (block_id) REFERENCES apex_030200.wwv_mig_olb_olt_block ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_olt_bi_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);