CREATE TABLE apex_030200.wwv_mig_olb_t_tp_gg_ct_txtsgt (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_t_tp_gg_ct_tsgt_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_ttpggctts_ctid_fk FOREIGN KEY (compoundtext_id) REFERENCES apex_030200.wwv_mig_olb_t_tp_gg_cpdtxt ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_ttpggctts_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);