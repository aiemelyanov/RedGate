CREATE TABLE apex_030200.wwv_mig_olb_t_tp_gggg_graphics (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_t_tp_gggg_grphs_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_ttpggggg_g_id_fk FOREIGN KEY (graphics_id) REFERENCES apex_030200.wwv_mig_olb_t_tp_ggg_graphics ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_ttpggggg_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);