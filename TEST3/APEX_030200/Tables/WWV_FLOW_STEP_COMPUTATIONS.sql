CREATE TABLE apex_030200.wwv_flow_step_computations (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_flow_step_comp_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_flow_step_comp_fk FOREIGN KEY (flow_id) REFERENCES apex_030200.wwv_flows ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_flow_step_comp_fk2 FOREIGN KEY (flow_id,flow_step_id) REFERENCES apex_030200.wwv_flow_steps (flow_id,"ID") ON DELETE CASCADE
);