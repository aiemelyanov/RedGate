CREATE TABLE apex_030200.wwv_mig_frm_blk_item_triggers (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_frm_blk_item_trg_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_frm_bi_trg_item_id_fk FOREIGN KEY (item_id) REFERENCES apex_030200.wwv_mig_frm_blk_items ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_frm_bi_trg_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);