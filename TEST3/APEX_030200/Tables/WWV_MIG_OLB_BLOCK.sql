CREATE TABLE apex_030200.wwv_mig_olb_block (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_block_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_block_objlib_id_fk FOREIGN KEY (objectlibrary_id) REFERENCES apex_030200.wwv_mig_olb_objectlibrary ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_block_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);