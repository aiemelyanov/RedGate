CREATE TABLE apex_030200.wwv_mig_olb_olt_tabpg_graphics (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_olt_tabpg_grphs_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_olt_tpg_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_olt_tpg_tp_id_fk FOREIGN KEY (tabpage_id) REFERENCES apex_030200.wwv_mig_olb_olt_tabpage ("ID") ON DELETE CASCADE
);