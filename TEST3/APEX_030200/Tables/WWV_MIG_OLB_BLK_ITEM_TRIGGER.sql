CREATE TABLE apex_030200.wwv_mig_olb_blk_item_trigger (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_blk_itm_trg_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_bit_item_id_fk FOREIGN KEY (item_id) REFERENCES apex_030200.wwv_mig_olb_blk_item ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_bit_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);