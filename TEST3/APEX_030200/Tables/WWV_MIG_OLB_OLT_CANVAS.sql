CREATE TABLE apex_030200.wwv_mig_olb_olt_canvas (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_olt_canvas_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_t_canvas_olt_id_fk FOREIGN KEY (objectlibrarytab_id) REFERENCES apex_030200.wwv_mig_olb_objectlibrarytab ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_t_canvas_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);