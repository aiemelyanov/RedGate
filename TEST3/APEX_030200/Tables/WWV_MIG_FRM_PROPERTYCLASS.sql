CREATE TABLE apex_030200.wwv_mig_frm_propertyclass (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_frm_propcls_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_frm_ppcl_frmmdl_id_fk FOREIGN KEY (formmodule_id) REFERENCES apex_030200.wwv_mig_frm_formmodules ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_frm_ppcl_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);