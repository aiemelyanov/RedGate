CREATE TABLE apex_030200.wwv_mig_olb_olt_graphics (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_olb_olt_graphics_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_olb_t_graphcs_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_t_grphcs_olt_id_fk FOREIGN KEY (objectlibrarytab_id) REFERENCES apex_030200.wwv_mig_olb_objectlibrarytab ("ID") ON DELETE CASCADE
);