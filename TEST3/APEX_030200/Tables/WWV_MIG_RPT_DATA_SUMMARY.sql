CREATE TABLE apex_030200.wwv_mig_rpt_data_summary (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT wwv_mig_repsum_pk PRIMARY KEY ("ID"),
  CONSTRAINT wwv_mig_repsum_id_fk FOREIGN KEY (data_id) REFERENCES apex_030200.wwv_mig_rpt_data ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_repsum_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES apex_030200.wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
);